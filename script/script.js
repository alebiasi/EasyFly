...
function create_standard_page(){
    ...
    var tr7 = document.createElement("tr");    //creazione info accessorie
    var td_acc_info = document.createElement("td");

    var form_acc_info =document.createElement("form");
    form_acc_info.method="POST";
    form_acc_info.action="/optional_info";
    form_acc_info.className="form";

    var btn_acc_info = document.createElement("input");
    btn_acc_info.type="submit";
    btn_acc_info.className="button_main";
    btn_acc_info.value="Informazioni accessorie";

    form_acc_info.appendChild(btn_acc_info);
    td_acc_info.appendChild(form_acc_info);
    tr7.appendChild(td_acc_info);
